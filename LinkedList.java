...
public class LinkedList {
	...
	public int indexOf(MemoryBlock block) {
		...
		while (iterator.hasNext()) { // IF I DONT HAVE NEXT AND ITS NULL, GETTING OUT OF THE LOOP.
			MemoryBlock b = iterator.next(); // RETURN THE VALUE OF THE CURRENT ELEMENT AND MOVING FORWARD
			if (b.equals(block)) {
				return counter;
			}
			counter++;
